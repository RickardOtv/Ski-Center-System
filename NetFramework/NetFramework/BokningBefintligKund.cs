...
namespace NetFramework
{
    public partial class BokningBefintligKund : Form
    {
        ...
        IList<Bokningsrad> valdBokningsRad;
        DateTime från;
        DateTime till;
